...
export function LiveDataDisclaimer({ cacheLifetime }: LiveDataDisclaimerProps) {
  ...
  const verbiage = (
    !isNullish(cacheLifetime)
    ? <>
      Live Data from this 3rd party service may be outdated by up to <strong style={{ textWrap: 'nowrap' }}>{cacheLifetime.toLocaleString()}</strong> due to <a href="https://www.cloudflare.com/learning/cdn/what-is-caching/">caching</a>.
      </>
    : <>
      Live Data from this 3rd party service may be outdated due to <a href="https://www.cloudflare.com/learning/cdn/what-is-caching/">caching</a>.
      </>
  )
