...
import { searchInputAtom } from '../lib/jotai'
import { useLiteSearchResults } from '../lib/services/useSearchResults'
...
export default function SearchBar() {
  ...
  const [_, setRef] = useAtom(searchInputAtom)
  ...
  const handleChange: AutocompleteProps<SearchResult, undefined, undefined, boolean | undefined>['onChange'] = (event, x) => {
    if(typeof x !== 'string' && x !== null) {
      ...
      router.navigate({ to: x.href, resetScroll: false });
    }
  }
