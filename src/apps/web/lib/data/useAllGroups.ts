import { Course, Group, LabeledLink, Section, DocumentReference, IsDocumentReferenceArray } from '@cougargrades/models'
...
export function group2Result(data: Group): GroupResult {
  return {
    ...
    courses: IsDocumentReferenceArray(data.courses) ? data.courses : [],
