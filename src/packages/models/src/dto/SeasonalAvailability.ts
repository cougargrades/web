...
import { z } from 'zod'
import { getYear, seasonCode, SeasonCode } from '../TermCode'
import { GetTotalEnrolled, Section } from '../Section';
import { sum } from '../Helpers';
import { SparklineData } from '../SparklineData';

export type SeasonalAvailability = z.infer<typeof SeasonalAvailability>
export const SeasonalAvailability = z.object({
  measured: z.record(SeasonCode, z.number()),
  ratioSorted: z.record(SeasonCode, z.number()),
})
