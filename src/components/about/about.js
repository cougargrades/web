        ...
        return (
            <Container className="about">
                ...
                <Row>
                    <Col>
                    <h4>Resources</h4>
                    <p>Front-end code, database processor, FOIA data, public HTTP API, and more, are published on Github.</p>
                    <p><Button href="https://github.com/cougargrades" variant="primary">Github</Button>&nbsp;<Button href="https://cougargrades.github.io/api/" variant="primary">Public API</Button>&nbsp;<Button href="https://github.com/search?utf8=%E2%9C%93&q=FOIA-IR+user%3Acougargrades&type=Repositories&ref=advsearch&l=&l=" variant="primary">Spreadsheets</Button></p>
                    ...
                    <h5>Technologies</h5>
                    <p>CougarGrades is powered by Google Firebase, React, Bootstrap, Sass, Google Charts API, Anime.js, and more.</p>

                    <h5>Author</h5>
                    <p>See <a href="https://austinj.net">austinj.net</a>.</p>
